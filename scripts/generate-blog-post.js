...
## 3. 독자를 위한 미니 보상 용어 사전 제공 (Readability & SEO)
- 본문 텍스트 내에는 '맥브라이드 장해평가', 'AMA 기준', '기왕증', '동요도', '휴업손해', '도시일용노임' 등 고도의 손해사정 전문 용어들을 괄호 설명 없이 문맥상 자연스럽게 그대로 사용하십시오.
- 대신, 본문의 최하단(자주 묻는 질문 FAQ 섹션 바로 위쪽)에 반드시 '## [💡 핵심 보상 용어 사전]' (H2) 섹션을 만들고, 본문에 언급된 전문 용어 2~3개의 뜻을 불릿(-)으로 명료하고 친절하게 정리하여 요약 박스 형태로 제공하십시오.
