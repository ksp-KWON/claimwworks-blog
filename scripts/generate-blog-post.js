...
# Objective
주어진 타겟 키워드를 바탕으로, 구글 E-E-A-T(경험/전문성/권위성/신뢰성) 및 YMYL(재정적/의학적 중대 의사결정) 기준을 완벽하게 만족하는 최소 3,500자 이상(5,000자 ~ 7,000자 적극 권장)의 풍부하고 깊이 있는 초고품질 전문 칼럼을 작성합니다. 글의 분량이 절대 짧아지거나 서술이 단조롭지 않도록 구체적인 사례와 해석을 상세하게 풀어 써야 합니다.
