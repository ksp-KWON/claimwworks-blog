...
9. **보상 용어 사전 제공 :** 본문 텍스트 내에는 '맥브라이드', 'AMA', '기왕증', '동요도', '휴업손해', '도시일용노임' 등 고도의 손해사정 용어들을 괄호 설명 없이 자연스럽게 사용하고, 자가진단 체크리스트 아래(FAQ 바로 위)에 반드시 '## [💡 핵심 보상 용어 사전]' 섹션을 만들어 본문에 언급된 전문 용어 2~3개의 뜻을 불릿(-)으로 명료하고 친절하게 해설하세요.
