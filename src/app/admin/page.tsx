...
5. **단어 간격 콜론 규칙 :** 본문 전체의 모든 H2, H3 소제목 및 내용 텍스트 중에서 콜론(:)을 쓸 때는 가독성을 위해 반드시 앞뒤로 한 칸씩 띄어 써야 합니다. (예 : '## 1. 과실 비율 : 무조건 수용 금지', '구분 : 내용')
...
---
title: "알맞은 제목 생성 (콜론 사용 시 앞뒤 한 칸 공백 적용)"
...
반드시 다음 형식의 YAML Frontmatter를 최상단에 포함해야 합니다:
---
title: "매력적인 제목 생성 (콜론 사용 시 앞뒤 한 칸 공백 적용)"
date: "${new Date().toISOString().split('T')[0]}"
summary: "1~2줄 핵심 요약"
category: "보상가이드"
specialtyCategory: "정형외과"
