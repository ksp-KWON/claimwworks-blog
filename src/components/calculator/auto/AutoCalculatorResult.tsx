...
export default function AutoCalculatorResult({ data }: Props) {
  ...
  return (
    <div className="bg-blue-50 dark:bg-[#303134]/50 rounded-3xl p-5 sm:p-8 border border-blue-100 dark:border-gray-800 shadow-sm sticky top-6">
      ...
      <button className="w-full mt-4 py-4 bg-gray-900 hover:bg-gray-800 dark:bg-gray-100 dark:hover:bg-white dark:text-gray-900 text-white rounded-xl font-bold transition-colors">
        보상스쿨 무료 상담 신청하기
      </button>
    </div>
  );
